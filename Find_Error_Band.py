...
error_pad.cd()
error_pad.SetLogy()
nom_hist, nom_graph, tot_stat_errors = FindErrorBands(datasets_sig,root_file,hist)
nom_hist.Draw("hist")
...
line.SetLineWidth(1)
line.SetLineStyle(1)
line.SetRange(0.0,0.0,5000,2.0)		# fix this so it gets the min_x and max_x from input nom_hist
...
error_pad.cd()
error_pad.SetLogy()
nom_hist, nom_graph, tot_stat_errors = FindErrorBands(datasets_back,root_file,hist)
nom_hist.Draw("hist")
nom_graph.SetFillColor(ROOT.TAttFill.kGreen)
nom_graph.Draw("E5 same")
nom_hist.GetYaxis().SetTitleOffset(1)
...
line.SetLineWidth(1)
line.SetLineStyle(1)
line.SetRange(0.0,0.0,5000,2.0)
line.SetMaximum(2.0)
line.SetMinimum(0.0)
line.GetYaxis().SetTitle("Nominal/Systematic")
line.Draw()
