...
def FindErrorBands(datasets,root_file,hist):
	rebin = 10					# Set this to how many bins should be merged (1 -> no change)
	...
	for bin in range(1,nbins+1):
		...
		for dataset in sequence:
			...
			diff = comp_bin_val - nom_bin_val
            		shift_unc = math.sqrt(comp_bin_err*comp_bin_err + nom_bin_err*nom_bin_err)
            		shifts.append(diff)
		...
		lower_error.append(math.sqrt(math.fsum(negative_shifts2)))
        	...
        	tot_stat_errors.append(0.25*math.sqrt(math.fsum(shifts_sum2))*math.sqrt(shift_time_unc_sum2))
...
def GetListDataset(list_name):
	...
	datasets_sig = 	["129916.Nominal_Sherpa_Signal", "147294.min_n_tchannels_CKKW30","147296.min_n_tchannels_MuFdown",
    	...
    	datasets_sig_MjjFilt = ["147295.min_n_tchannels_CKKW30_MjjFilt","147297.min_n_tchannels_MuFdown_MjjFilt","147299.min_n_tchannels_MuFup_MjjFilt",
    	...
    	datasets_back_MjjFilt = ["147311.CKKW30_MjjFilt","147313.MuFdown_MjjFilt","147315.MuFup_MjjFilt","147317.mpi1_MjjFilt",
