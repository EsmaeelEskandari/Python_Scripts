...
folder_list = [ x for x in dir_contents if os.path.isdir(x) and "user.cjohnson" in x]
print "The number of unsorted directories to in pwd is: "+str(len(folder_list))
